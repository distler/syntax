...
The official mtainained fork of this library is here[https://github.com/dblock/syntax]. However, there's currently none or not much new development going on and the original author, @jamis[https://github.com/jamis], recommends using CodeRay[http://coderay.rubychan.de], over this library.
